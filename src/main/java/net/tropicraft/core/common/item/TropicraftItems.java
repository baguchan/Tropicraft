...
public class TropicraftItems {
    ...
    public static final ItemEntry<Item> ROASTED_COFFEE_BEAN = simpleItem("roasted_coffee_bean")
            .recipe((ctx, prov) -> prov.food(DataIngredient.items(RAW_COFFEE_BEAN), RecipeCategory.FOOD, ctx, 0.1f))
            .register();
    ...
    public static final ItemEntry<Item> SEARED_MARLIN = food("seared_marlin", Foods.SEARED_MARLIN)
            .recipe((ctx, prov) -> prov.food(DataIngredient.items(FRESH_MARLIN), RecipeCategory.FOOD, ctx, 0.15f))
            .register();
    ...
    public static final ItemEntry<Item> COOKED_RAY = food("cooked_ray", Foods.COOKED_RAY)
            .recipe((ctx, prov) -> prov.food(DataIngredient.items(RAW_RAY), RecipeCategory.FOOD, ctx, 0.15f))
            .register();
    ...
    public static final ItemEntry<Item> COOKED_FROG_LEG = food("cooked_frog_leg", Foods.COOKED_FROG_LEG)
            .recipe((ctx, prov) -> prov.food(DataIngredient.items(FROG_LEG), RecipeCategory.FOOD, ctx, 0.1f))
            .register();
    ...
    public static final ItemEntry<Item> COOKED_FISH = food("cooked_fish", Foods.COOKED_FISH)
            .tag(ItemTags.FISHES)
            .recipe((ctx, prov) -> prov.food(DataIngredient.items(RAW_FISH), RecipeCategory.FOOD, ctx, 0.1f))
